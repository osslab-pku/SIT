...
#   timestamp: 2024-08-07T09:38:55+00:00
...
class HasExtractedLicensingInfo(BaseModel):
    ...
    name: Optional[str] = Field(None, description='Identify name of this SpdxElement.')
    seeAlsos: Optional[List[str]] = None
...
class ReferenceCategory(Enum):
    ...
    PERSISTENT_ID_1 = 'PERSISTENT_ID'
    SECURITY = 'SECURITY'
    PACKAGE_MANAGER = 'PACKAGE-MANAGER'
    PACKAGE_MANAGER_1 = 'PACKAGE_MANAGER'
...
class File(BaseModel):
    ...
    fileTypes: Optional[List[FileType]] = Field(
        None, description='The type of the file.'
    )
    licenseComments: Optional[str] = Field(
        None,
        description='The licenseComments property allows the preparer of the SPDX document to describe why the licensing in spdx:licenseConcluded was chosen.',
...
class EndPointer(BaseModel):
    ...
    offset: Optional[int] = Field(None, description='Byte offset in the file')
    lineNumber: Optional[int] = Field(
        None, description='line number offset in the file'
    )
...
class Spdx23(BaseModel):
    ...
    field_schema: Optional[str] = Field(
        None, alias='$schema', description='Reference the SPDX 2.3 JSON schema.'
    )
    SPDXID: str = Field(
        ...,
        description='Uniquely identify any element in an SPDX document which may be referenced by other elements.',
    ...
    name: str = Field(..., description='Identify name of this SpdxElement.')
    revieweds: Optional[List[Reviewed]] = Field(None, description='Reviewed')
